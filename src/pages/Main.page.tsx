    ...
    return (
        <ShelterPage>
            <Grid container spacing={2} justifyContent="center" alignItems="center">
                ...
                <Grid item sm={12}>
                    <Box>
                        <Typography paragraph>Area you a woman with childs? We can pay a room in hotel for you. Click on the button to proceed</Typography>
                        <br />
                        <Button href="https://forms.gle/5ZaTVLhPMXij47VS8"
                            variant="contained"
                            color="warning"
                            size="large">
                            CONTACT US
                        ...
                        <br />
                        <Typography paragraph sx={{ display: "flex", alignItems: "center" }} component="div">
                            <strong>Use this option if no shelter is available</strong>
